...
Uses iface.getFeatureForm() to render the native QGIS attribute form,
matching the look of the built-in feature form exactly.
"""
...
from qgis.PyQt.QtWidgets import (
    ...
    QGroupBox, QSpinBox, QToolButton
)
...
class FeatureNavEdDockWidget(QDockWidget):
    ...
    def _build_ui(self):
        ...
        self.sort_order_btn.setIcon(
            QgsApplication.getThemeIcon('/mActionSortByAttribute.svg')
        )
        self.sort_order_btn.setToolTip("Click to toggle sort order")
        self.sort_order_btn.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)
    ...
    def _toggle_sort_order(self):
        ...
        if self.sort_ascending:
            ...
            self.sort_order_btn.setIcon(
                QgsApplication.getThemeIcon('/mActionSortByAttributeDesc.svg')
            )
        self._reload_features()
    ...
    def _accept_current_form(self):
        """Accept (save) the current feature form if it exists."""
    ...
    def _show_feature_form(self, layer, feature):
        ...
        try:
            ...
            self._form_placeholder.setText("Cannot display feature form")
